...
# filter out XSS!
def filter_str(str):
    return (re.search("script", str, re.IGNORECASE) or 
        re.search("onload", str, re.IGNORECASE) or
        re.search("onerror", str, re.IGNORECASE))
...
if __name__ == "__main__":
	app.run(host='0.0.0.0', port=40007, threaded=True)
